<p><b>This is a fork of <a href="https://github.com/Rodpad/LeGo2-Fan-Control-Decky">Rodpad/LeGo2-Fan-Control-Decky</a> by Luke Cama (GPL-3.0) with Lenovo Legion Go 1 (83E1) support added:</b> a Full Fan Speed toggle (the firmware's own override), live temp/RPM monitoring, and one-click installation of the acpi-call module on pacman-based distros such as CachyOS. All Legion Go 2 functionality is unchanged.</p>
